...
In order to simplify the problem, it was decided to split the four legs in two sub-parts: two front legs and two back legs. This decision exploits the fact that \textit{"fore and hind quarters of dogs behaved like two independent bipeds"} as demonstrated in.\\%%TODO: reference bio-paper. 
...
\subsection{Pre-processing and increasing the dataset}
