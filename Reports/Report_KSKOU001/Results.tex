...
\begin{enumerate}
	...
	Thus, for a given sequence of measurements, can be attributed to the model that outputs the highest log-likelihood value. %%TODO: ref continuous and chest mounted imu papers 
