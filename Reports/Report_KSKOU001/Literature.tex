...
\end{enumerate} 
The three assumptions make an HMM a relatively simple graphical model to implemented. This simplicity naturally comes with some limitations in modeling more complex problems which, however, may be modeled with higher-order HMMs. %%TODO: look for ref for this fact
