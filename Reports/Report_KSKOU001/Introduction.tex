...
To achieve the above objectives the hypotheses below will be investigated in this project:
\begin{itemize}
	\item HMMs can successfully model gait sequence dynamics using IMU data, in the absence of enough training samples.
